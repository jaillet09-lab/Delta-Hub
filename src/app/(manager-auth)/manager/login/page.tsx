...
export default function ManagerLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Managers use their full email address
    const email = login.includes('@') ? login : `${login}@deltacleaning.com.au`

    const supabase = createClient() // auto-selects sb-manager cookie namespace
